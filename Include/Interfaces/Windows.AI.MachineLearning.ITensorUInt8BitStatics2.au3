...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorUInt8BitStatics2
...
Global Const $sIID_ITensorUInt8BitStatics2 = "{2BA042D6-373E-5A3A-A2FC-A6C41BD52789}"
$__g_mIIDs[$sIID_ITensorUInt8BitStatics2] = "ITensorUInt8BitStatics2"

Global Const $tagITensorUInt8BitStatics2 = $tagIInspectable & _
...
Func ITensorUInt8BitStatics2_CreateFromShapeArrayAndDataArray($pThis, $aShape, $dData)
...
Func ITensorUInt8BitStatics2_CreateFromBuffer($pThis, $aShape, $pBuffer)
	Local $vFailVal = Ptr(0)
