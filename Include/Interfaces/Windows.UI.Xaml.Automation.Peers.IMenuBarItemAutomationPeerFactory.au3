...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Automation.Peers.IMenuBarItemAutomationPeerFactory
# Incl. In  : Windows.UI.Xaml.Automation.Peers.MenuBarItemAutomationPeer

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IMenuBarItemAutomationPeerFactory = "{C9C77746-130F-5B19-83A6-61DB584613AA}"
