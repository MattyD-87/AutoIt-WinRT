...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Automation.Peers.IListViewItemAutomationPeerFactory
# Incl. In  : Windows.UI.Xaml.Automation.Peers.ListViewItemAutomationPeer

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IListViewItemAutomationPeerFactory = "{C47DFBC0-FACC-4024-A73B-17EC4E662654}"
