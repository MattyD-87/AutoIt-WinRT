...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Lights.Effects.ILampArraySolidEffectFactory
...
Global Const $sIID_ILampArraySolidEffectFactory = "{F862A32C-5576-4341-961B-AEE1F13CF9DD}"
$__g_mIIDs[$sIID_ILampArraySolidEffectFactory] = "ILampArraySolidEffectFactory"

Global Const $tagILampArraySolidEffectFactory = $tagIInspectable & _
		"CreateInstance hresult(ptr; int; struct*; ptr*);" ; In $pLampArray, In $iLampIndexesCnt, $tLampIndexes, Out $pValue

Func ILampArraySolidEffectFactory_CreateInstance($pThis, $pLampArray, $aLampIndexes)
