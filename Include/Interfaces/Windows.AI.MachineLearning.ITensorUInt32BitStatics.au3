...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorUInt32BitStatics
...
Global Const $sIID_ITensorUInt32BitStatics = "{417C3837-E773-4378-8E7F-0CC33DBEA697}"
$__g_mIIDs[$sIID_ITensorUInt32BitStatics] = "ITensorUInt32BitStatics"

Global Const $tagITensorUInt32BitStatics = $tagIInspectable & _
...
Func ITensorUInt32BitStatics_Create($pThis)
...
Func ITensorUInt32BitStatics_Create2($pThis, $pShape)
	Local $vFailVal = Ptr(0)
...
Func ITensorUInt32BitStatics_CreateFromArray($pThis, $pShape, $aData)
	Local $vFailVal = Ptr(0)
...
Func ITensorUInt32BitStatics_CreateFromIterable($pThis, $pShape, $pData)
	Local $vFailVal = Ptr(0)
