...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorInt32BitStatics
# Incl. In  : Windows.AI.MachineLearning.TensorInt32Bit

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ITensorInt32BitStatics = "{6539864B-52FA-4E35-907C-834CAC417B50}"
$__g_mIIDs[$sIID_ITensorInt32BitStatics] = "ITensorInt32BitStatics"

Global Const $tagITensorInt32BitStatics = $tagIInspectable & _
...
Func ITensorInt32BitStatics_Create($pThis)
...
Func ITensorInt32BitStatics_Create2($pThis, $pShape)
	Local $vFailVal = Ptr(0)
...
Func ITensorInt32BitStatics_CreateFromArray($pThis, $pShape, $aData)
	Local $vFailVal = Ptr(0)
	...
	Local $tData = DllStructCreate(StringFormat("int[%d]", $iDataCnt))
...
Func ITensorInt32BitStatics_CreateFromIterable($pThis, $pShape, $pData)
	Local $vFailVal = Ptr(0)
