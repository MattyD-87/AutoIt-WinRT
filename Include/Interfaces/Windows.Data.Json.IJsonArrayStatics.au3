...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Data.Json.IJsonArrayStatics
...
Global Const $sIID_IJsonArrayStatics = "{DB1434A9-E164-499F-93E2-8A8F49BB90BA}"
$__g_mIIDs[$sIID_IJsonArrayStatics] = "IJsonArrayStatics"

Global Const $tagIJsonArrayStatics = $tagIInspectable & _
		"Parse hresult(handle; ptr*);" & _ ; In $hInput, Out $pJsonArray
		"TryParse hresult(handle; ptr*; bool*);" ; In $hInput, Out $pResult, Out $bSucceeded

Func IJsonArrayStatics_Parse($pThis, $sInput)
...
Func IJsonArrayStatics_TryParse($pThis, $sInput, ByRef $pResult)
	Local $vFailVal = Null
