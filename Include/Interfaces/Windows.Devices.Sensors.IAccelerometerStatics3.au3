...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Sensors.IAccelerometerStatics3
...
Global Const $sIID_IAccelerometerStatics3 = "{9DE218CF-455D-4CF3-8200-70E1410340F8}"
$__g_mIIDs[$sIID_IAccelerometerStatics3] = "IAccelerometerStatics3"

Global Const $tagIAccelerometerStatics3 = $tagIInspectable & _
		"FromIdAsync hresult(handle; ptr*);" & _ ; In $hDeviceId, Out $pOperation
		"GetDeviceSelector hresult(long; handle*);" ; In $iReadingType, Out $hResult

Func IAccelerometerStatics3_FromIdAsync($pThis, $sDeviceId)
...
Func IAccelerometerStatics3_GetDeviceSelector($pThis, $iReadingType)
	Local $vFailVal = ""
