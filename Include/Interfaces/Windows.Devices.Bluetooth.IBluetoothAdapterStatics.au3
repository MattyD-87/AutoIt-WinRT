...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Bluetooth.IBluetoothAdapterStatics
...
Global Const $sIID_IBluetoothAdapterStatics = "{8B02FB6A-AC4C-4741-8661-8EAB7D17EA9F}"
$__g_mIIDs[$sIID_IBluetoothAdapterStatics] = "IBluetoothAdapterStatics"

Global Const $tagIBluetoothAdapterStatics = $tagIInspectable & _
...
Func IBluetoothAdapterStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func IBluetoothAdapterStatics_FromIdAsync($pThis, $sDeviceId)
...
Func IBluetoothAdapterStatics_GetDefaultAsync($pThis)
	Local $vFailVal = Ptr(0)
