...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Security.Cryptography.Certificates.ICertificateEnrollmentManagerStatics
...
Global Const $sIID_ICertificateEnrollmentManagerStatics = "{8846EF3F-A986-48FB-9FD7-9AEC06935BF1}"
$__g_mIIDs[$sIID_ICertificateEnrollmentManagerStatics] = "ICertificateEnrollmentManagerStatics"

Global Const $tagICertificateEnrollmentManagerStatics = $tagIInspectable & _
		...
		"ImportPfxDataAsync hresult(handle; handle; long; long; ulong; handle; ptr*);" ; In $hPfxData, In $hPassword, In $iExportable, In $iKeyProtectionLevel, In $iInstallOption, In $hFriendlyName, Out $pValue

Func ICertificateEnrollmentManagerStatics_CreateRequestAsync($pThis, $pRequest)
...
Func ICertificateEnrollmentManagerStatics_InstallCertificateAsync($pThis, $sCertificate, $iInstallOption)
	Local $vFailVal = Ptr(0)
...
Func ICertificateEnrollmentManagerStatics_ImportPfxDataAsync($pThis, $sPfxData, $sPassword, $iExportable, $iKeyProtectionLevel, $iInstallOption, $sFriendlyName)
	Local $vFailVal = Ptr(0)
