...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Controls.IDatePickerSelectedValueChangedEventArgs
# Incl. In  : Windows.UI.Xaml.Controls.DatePickerSelectedValueChangedEventArgs

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IDatePickerSelectedValueChangedEventArgs = "{564DCEED-744A-5C3A-9BD2-4DCD9919A7B7}"
