...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.Graphics.Display.IDisplayInformationStatics
...
Global Const $sIID_IDisplayInformationStatics = "{2DE85048-37FA-56C0-AC30-47E2044D7EA8}"
...
Global Const $tagIDisplayInformationStatics = $tagIInspectable & _
		"CreateForWindowId hresult(uint64; ptr*);" & _ ; In $iWindowId, Out $pResult
		"CreateForDisplayId hresult(uint64; ptr*);" ; In $iDisplayId, Out $pResult

Func IDisplayInformationStatics_CreateForWindowId($pThis, $iWindowId)
...
Func IDisplayInformationStatics_CreateForDisplayId($pThis, $iDisplayId)
	Local $vFailVal = Ptr(0)
