...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Automation.Peers.IAutomationPeerOverrides
...
Global Const $sIID_IAutomationPeerOverrides = "{44F8F6DF-1B60-512D-A295-DD8C276C4618}"
...
Global Const $tagIAutomationPeerOverrides = $tagIInspectable & _
		...
		"NavigateCore hresult(long; ptr*);" & _ ; In $iDirection, Out $pResult
		...
		"GetElementFromPointCore hresult(struct; ptr*);" & _ ; In $tPointInWindowCoordinates, Out $pResult
		"GetFocusedElementCore hresult(ptr*);" & _ ; Out $pResult
		"GetLiveSettingCore hresult(long*);" & _ ; Out $iResult
		"ShowContextMenuCore hresult();" & _ ; 
		"GetControlledPeersCore hresult(ptr*);" & _ ; Out $pResult
		"GetAnnotationsCore hresult(ptr*);" & _ ; Out $pResult
		"GetPositionInSetCore hresult(long*);" & _ ; Out $iResult
		"GetSizeOfSetCore hresult(long*);" & _ ; Out $iResult
		"GetLevelCore hresult(long*);" & _ ; Out $iResult
		"GetLandmarkTypeCore hresult(long*);" & _ ; Out $iResult
		"GetLocalizedLandmarkTypeCore hresult(handle*);" & _ ; Out $hResult
		"IsPeripheralCore hresult(bool*);" & _ ; Out $bResult
		"IsDataValidForFormCore hresult(bool*);" & _ ; Out $bResult
		"GetFullDescriptionCore hresult(handle*);" & _ ; Out $hResult
		"GetDescribedByCore hresult(ptr*);" & _ ; Out $pResult
		"GetFlowsToCore hresult(ptr*);" & _ ; Out $pResult
		"GetFlowsFromCore hresult(ptr*);" & _ ; Out $pResult
		"GetCultureCore hresult(long*);" & _ ; Out $iResult
		"GetHeadingLevelCore hresult(long*);" & _ ; Out $iResult
		"IsDialogCore hresult(bool*);" ; Out $bResult
...
Func IAutomationPeerOverrides_NavigateCore($pThis, $iDirection)
	Local $vFailVal = Ptr(0)
...
Func IAutomationPeerOverrides_GetElementFromPointCore($pThis, $tPointInWindowCoordinates)
	Local $vFailVal = Ptr(0)
...
Func IAutomationPeerOverrides_GetFocusedElementCore($pThis)
	Local $vFailVal = Ptr(0)
...
Func IAutomationPeerOverrides_ShowContextMenuCore($pThis)
	Local $vFailVal = False
...
Func IAutomationPeerOverrides_GetControlledPeersCore($pThis)
	Local $vFailVal = Ptr(0)
...
Func IAutomationPeerOverrides_GetAnnotationsCore($pThis)
	Local $vFailVal = Ptr(0)
...
Func IAutomationPeerOverrides_GetPositionInSetCore($pThis)
	Local $vFailVal = 0
...
Func IAutomationPeerOverrides_GetSizeOfSetCore($pThis)
	Local $vFailVal = 0
...
Func IAutomationPeerOverrides_GetLevelCore($pThis)
	Local $vFailVal = 0
...
Func IAutomationPeerOverrides_GetLandmarkTypeCore($pThis)
	Local $vFailVal = 0
...
Func IAutomationPeerOverrides_GetLocalizedLandmarkTypeCore($pThis)
	Local $vFailVal = ""
...
Func IAutomationPeerOverrides_IsPeripheralCore($pThis)
	Local $vFailVal = Null
...
Func IAutomationPeerOverrides_IsDataValidForFormCore($pThis)
	Local $vFailVal = Null
...
Func IAutomationPeerOverrides_GetFullDescriptionCore($pThis)
	Local $vFailVal = ""
...
Func IAutomationPeerOverrides_GetDescribedByCore($pThis)
	Local $vFailVal = Ptr(0)
...
Func IAutomationPeerOverrides_GetFlowsToCore($pThis)
	Local $vFailVal = Ptr(0)
...
Func IAutomationPeerOverrides_GetFlowsFromCore($pThis)
	Local $vFailVal = Ptr(0)
...
Func IAutomationPeerOverrides_GetCultureCore($pThis)
	Local $vFailVal = 0
...
Func IAutomationPeerOverrides_GetHeadingLevelCore($pThis)
	Local $vFailVal = 0
...
Func IAutomationPeerOverrides_IsDialogCore($pThis)
	Local $vFailVal = Null
