...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorInt16BitStatics2
...
Global Const $sIID_ITensorInt16BitStatics2 = "{0CD70CF4-696C-5E5F-95D8-5EBF9670148B}"
$__g_mIIDs[$sIID_ITensorInt16BitStatics2] = "ITensorInt16BitStatics2"

Global Const $tagITensorInt16BitStatics2 = $tagIInspectable & _
...
Func ITensorInt16BitStatics2_CreateFromShapeArrayAndDataArray($pThis, $aShape, $aData)
...
Func ITensorInt16BitStatics2_CreateFromBuffer($pThis, $aShape, $pBuffer)
	Local $vFailVal = Ptr(0)
