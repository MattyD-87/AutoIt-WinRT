...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.ILineDisplayStatics
...
Global Const $sIID_ILineDisplayStatics = "{022DC0B6-11B0-4690-9547-0B39C5AF2114}"
$__g_mIIDs[$sIID_ILineDisplayStatics] = "ILineDisplayStatics"

Global Const $tagILineDisplayStatics = $tagIInspectable & _
...
Func ILineDisplayStatics_FromIdAsync($pThis, $sDeviceId)
...
Func ILineDisplayStatics_GetDefaultAsync($pThis)
	Local $vFailVal = Ptr(0)
...
Func ILineDisplayStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func ILineDisplayStatics_GetDeviceSelector2($pThis, $iConnectionTypes)
	Local $vFailVal = ""
