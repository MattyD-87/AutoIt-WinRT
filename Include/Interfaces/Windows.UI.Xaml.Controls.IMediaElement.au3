...
Global Const $tagIMediaElement = $tagIInspectable & _
		...
		"get_CurrentState hresult(long*);" & _ ; Out $iValue
		...
		"put_AudioDeviceType hresult(long);" & _ ; In $iValue
		"get_ProtectionManager hresult(ptr*);" & _ ; Out $pValue
		"put_ProtectionManager hresult(ptr);" & _ ; In $pValue
		"get_Stereo3DVideoPackingMode hresult(long*);" & _ ; Out $iValue
		"put_Stereo3DVideoPackingMode hresult(long);" & _ ; In $iValue
		"get_Stereo3DVideoRenderMode hresult(long*);" & _ ; Out $iValue
		"put_Stereo3DVideoRenderMode hresult(long);" & _ ; In $iValue
		...
		"Play hresult();" & _ ; 
		"Pause hresult();" & _ ; 
		"CanPlayType hresult(handle; long*);" & _ ; In $hType, Out $iResult
		...
		"get_ActualStereo3DVideoPackingMode hresult(long*);" ; Out $iValue
...
Func IMediaElement_SetStereo3DVideoPackingMode($pThis, $iValue)
	Local $vValue = __WinRT_SetProperty_Number($pThis, 53, "long", $iValue)
	Return SetError(@error, @extended, $vValue)
EndFunc
...
Func IMediaElement_CanPlayType($pThis, $sType)
	...
	Local $aCall = DllCallAddress("long", $pFunc, "ptr", $pThis, "handle", $hType, "long*", 0)
	Local $iError = @error
