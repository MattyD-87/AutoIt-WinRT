...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Composition.IBounceEasingFunction
# Incl. In  : Windows.UI.Composition.BounceEasingFunction

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IBounceEasingFunction = "{E7FDB44B-AAD5-5174-9421-EEF8B75A6A43}"
