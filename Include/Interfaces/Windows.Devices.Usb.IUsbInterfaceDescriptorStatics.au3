...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Usb.IUsbInterfaceDescriptorStatics
...
Global Const $sIID_IUsbInterfaceDescriptorStatics = "{E34A9FF5-77D6-48B6-B0BE-16C6422316FE}"
$__g_mIIDs[$sIID_IUsbInterfaceDescriptorStatics] = "IUsbInterfaceDescriptorStatics"

Global Const $tagIUsbInterfaceDescriptorStatics = $tagIInspectable & _
		"TryParse hresult(ptr; ptr*; bool*);" & _ ; In $pDescriptor, Out $pParsed, Out $bSuccess
		"Parse hresult(ptr; ptr*);" ; In $pDescriptor, Out $pParsed

Func IUsbInterfaceDescriptorStatics_TryParse($pThis, $pDescriptor, ByRef $pParsed)
	Local $vFailVal = Null
...
Func IUsbInterfaceDescriptorStatics_Parse($pThis, $pDescriptor)
