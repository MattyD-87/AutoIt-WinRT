...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Input.IManipulationCompletedRoutedEventArgs
# Incl. In  : Windows.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IManipulationCompletedRoutedEventArgs = "{B5AD9B23-2F41-498E-8319-015EE8A75346}"
