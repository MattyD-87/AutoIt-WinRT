...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.Provider.IBarcodeScannerStartSoftwareTriggerRequest2
...
Global Const $sIID_IBarcodeScannerStartSoftwareTriggerRequest2 = "{EB72A25C-6658-4765-A68E-327482653DEB}"
$__g_mIIDs[$sIID_IBarcodeScannerStartSoftwareTriggerRequest2] = "IBarcodeScannerStartSoftwareTriggerRequest2"

Global Const $tagIBarcodeScannerStartSoftwareTriggerRequest2 = $tagIInspectable & _
...
Func IBarcodeScannerStartSoftwareTriggerRequest2_ReportFailedAsync($pThis, $iReason)
...
Func IBarcodeScannerStartSoftwareTriggerRequest2_ReportFailedAsync2($pThis, $iReason, $sFailedReasonDescription)
	Local $vFailVal = Ptr(0)
