...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Composition.ICompositionColorGradientStop
# Incl. In  : Windows.UI.Composition.CompositionColorGradientStop

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ICompositionColorGradientStop = "{6F00CA92-C801-4E41-9A8F-A53E20F57778}"
