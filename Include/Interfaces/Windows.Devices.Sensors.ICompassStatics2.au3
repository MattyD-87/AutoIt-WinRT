...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Sensors.ICompassStatics2
...
Global Const $sIID_ICompassStatics2 = "{0ACE0EAD-3BAA-4990-9CE4-BE0913754ED2}"
$__g_mIIDs[$sIID_ICompassStatics2] = "ICompassStatics2"

Global Const $tagICompassStatics2 = $tagIInspectable & _
		"GetDeviceSelector hresult(handle*);" & _ ; Out $hResult
		"FromIdAsync hresult(handle; ptr*);" ; In $hDeviceId, Out $pOperation

Func ICompassStatics2_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func ICompassStatics2_FromIdAsync($pThis, $sDeviceId)
