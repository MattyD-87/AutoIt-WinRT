...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Perception.IPerceptionInfraredFrameSource
...
Global Const $sIID_IPerceptionInfraredFrameSource = "{55B08742-1808-494E-9E30-9D2A7BE8F700}"
$__g_mIIDs[$sIID_IPerceptionInfraredFrameSource] = "IPerceptionInfraredFrameSource"

Global Const $tagIPerceptionInfraredFrameSource = $tagIInspectable & _
...
Func IPerceptionInfraredFrameSource_AddHdlrAvailableChanged($pThis, $pHandler)
	Local $vValue = __WinRT_AddHandler($pThis, 7, $pHandler)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_RemoveHdlrAvailableChanged($pThis, $iToken)
	Local $vValue = __WinRT_RemoveHandler($pThis, 8, $iToken)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_AddHdlrActiveChanged($pThis, $pHandler)
	Local $vValue = __WinRT_AddHandler($pThis, 9, $pHandler)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_RemoveHdlrActiveChanged($pThis, $iToken)
	Local $vValue = __WinRT_RemoveHandler($pThis, 10, $iToken)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_AddHdlrPropertiesChanged($pThis, $pHandler)
	Local $vValue = __WinRT_AddHandler($pThis, 11, $pHandler)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_RemoveHdlrPropertiesChanged($pThis, $iToken)
	Local $vValue = __WinRT_RemoveHandler($pThis, 12, $iToken)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_AddHdlrVideoProfileChanged($pThis, $pHandler)
	Local $vValue = __WinRT_AddHandler($pThis, 13, $pHandler)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_RemoveHdlrVideoProfileChanged($pThis, $iToken)
	Local $vValue = __WinRT_RemoveHandler($pThis, 14, $iToken)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_AddHdlrCameraIntrinsicsChanged($pThis, $pHandler)
	Local $vValue = __WinRT_AddHandler($pThis, 15, $pHandler)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_RemoveHdlrCameraIntrinsicsChanged($pThis, $iToken)
	Local $vValue = __WinRT_RemoveHandler($pThis, 16, $iToken)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetId($pThis)
	Local $vValue = __WinRT_GetProperty_HString($pThis, 17)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetDisplayName($pThis)
	Local $vValue = __WinRT_GetProperty_HString($pThis, 18)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetDeviceKind($pThis)
	Local $vValue = __WinRT_GetProperty_HString($pThis, 19)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetAvailable($pThis)
	Local $vValue = __WinRT_GetProperty_Bool($pThis, 20)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetActive($pThis)
	Local $vValue = __WinRT_GetProperty_Bool($pThis, 21)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetIsControlled($pThis)
	Local $vValue = __WinRT_GetProperty_Bool($pThis, 22)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetProperties($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 23)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetSupportedVideoProfiles($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 24)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetAvailableVideoProfiles($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 25)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetVideoProfile($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 26)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_GetCameraIntrinsics($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 27)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IPerceptionInfraredFrameSource_AcquireControlSession($pThis)
...
Func IPerceptionInfraredFrameSource_CanControlIndependentlyFrom($pThis, $sTargetId)
	Local $vFailVal = Null
...
Func IPerceptionInfraredFrameSource_IsCorrelatedWith($pThis, $sTargetId)
	Local $vFailVal = Null
...
Func IPerceptionInfraredFrameSource_TryGetTransformTo($pThis, $sTargetId, ByRef $pResult)
	Local $vFailVal = Null
...
Func IPerceptionInfraredFrameSource_TryGetDepthCorrelatedCameraIntrinsicsAsync($pThis, $pTarget)
	Local $vFailVal = Ptr(0)
...
Func IPerceptionInfraredFrameSource_TryGetDepthCorrelatedCoordinateMapperAsync($pThis, $sTargetId, $pDepthFrameSourceToMapWith)
	Local $vFailVal = Ptr(0)
...
Func IPerceptionInfraredFrameSource_TrySetVideoProfileAsync($pThis, $pControlSession, $pProfile)
	Local $vFailVal = Ptr(0)
...
Func IPerceptionInfraredFrameSource_OpenReader($pThis)
	Local $vFailVal = Ptr(0)
