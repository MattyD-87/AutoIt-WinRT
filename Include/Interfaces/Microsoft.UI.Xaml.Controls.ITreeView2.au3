...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.ITreeView2
...
Global Const $sIID_ITreeView2 = "{B947CA7D-0F6F-594C-83EC-14153D343225}"
...
Global Const $tagITreeView2 = $tagIInspectable & _
		...
		"get_SelectedNode hresult(ptr*);" & _ ; Out $pValue
		"put_SelectedNode hresult(ptr);" & _ ; In $pValue
		"get_SelectedItem hresult(ptr*);" & _ ; Out $pValue
		"put_SelectedItem hresult(ptr);" & _ ; In $pValue
		"get_SelectedItems hresult(ptr*);" ; Out $pValue
...
Func ITreeView2_GetSelectedNode($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 31)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITreeView2_SetSelectedNode($pThis, $pValue)
	Local $vValue = __WinRT_SetProperty_Ptr($pThis, 32, $pValue)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITreeView2_GetSelectedItem($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 33)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITreeView2_SetSelectedItem($pThis, $pValue)
	Local $vValue = __WinRT_SetProperty_Ptr($pThis, 34, $pValue)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITreeView2_GetSelectedItems($pThis)
