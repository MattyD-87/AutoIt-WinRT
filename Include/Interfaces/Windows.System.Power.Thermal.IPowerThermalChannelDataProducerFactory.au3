...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.System.Power.Thermal.IPowerThermalChannelDataProducerFactory
...
Global Const $sIID_IPowerThermalChannelDataProducerFactory = "{D2D380CD-E09D-5472-AD62-70061E630067}"
$__g_mIIDs[$sIID_IPowerThermalChannelDataProducerFactory] = "IPowerThermalChannelDataProducerFactory"

Global Const $tagIPowerThermalChannelDataProducerFactory = $tagIInspectable & _
		"CreateInstance hresult(int; struct*; ptr*);" ; In $iChannelIdsCnt, $tChannelIds, Out $pValue

Func IPowerThermalChannelDataProducerFactory_CreateInstance($pThis, $aChannelIds)
