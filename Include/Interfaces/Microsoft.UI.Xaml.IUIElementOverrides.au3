...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.IUIElementOverrides
...
Global Const $tagIUIElementOverrides = $tagIInspectable & _
		...
		"FindSubElementsForTouchTargeting hresult(struct; struct; ptr*);" & _ ; In $tPoint, In $tBoundingRect, Out $pResult
		"GetChildrenInTabFocusOrder hresult(ptr*);" & _ ; Out $pResult
		"OnKeyboardAcceleratorInvoked hresult(ptr);" & _ ; In $pArgs
		"OnProcessKeyboardAccelerators hresult(ptr);" & _ ; In $pArgs
		"OnBringIntoViewRequested hresult(ptr);" & _ ; In $pE
