...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.IGridLengthHelperStatics
# Incl. In  : Windows.UI.Xaml.GridLengthHelper

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IGridLengthHelperStatics = "{9D457B9B-019F-4266-8872-215F198F6A9D}"
