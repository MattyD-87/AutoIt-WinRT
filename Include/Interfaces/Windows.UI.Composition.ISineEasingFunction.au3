...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Composition.ISineEasingFunction
# Incl. In  : Windows.UI.Composition.SineEasingFunction

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ISineEasingFunction = "{F1B518BF-9563-5474-BD13-44B2DF4B1D58}"
