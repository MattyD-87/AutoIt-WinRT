...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Lights.Effects.ILampArrayCustomEffectFactory
...
Global Const $sIID_ILampArrayCustomEffectFactory = "{68B4774D-63E5-4AF0-A58B-3E535B94E8C9}"
$__g_mIIDs[$sIID_ILampArrayCustomEffectFactory] = "ILampArrayCustomEffectFactory"

Global Const $tagILampArrayCustomEffectFactory = $tagIInspectable & _
		"CreateInstance hresult(ptr; int; struct*; ptr*);" ; In $pLampArray, In $iLampIndexesCnt, $tLampIndexes, Out $pValue

Func ILampArrayCustomEffectFactory_CreateInstance($pThis, $pLampArray, $aLampIndexes)
