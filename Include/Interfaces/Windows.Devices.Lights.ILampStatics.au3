...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Lights.ILampStatics
...
Global Const $sIID_ILampStatics = "{A822416C-8885-401E-B821-8E8B38A8E8EC}"
$__g_mIIDs[$sIID_ILampStatics] = "ILampStatics"

Global Const $tagILampStatics = $tagIInspectable & _
...
Func ILampStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func ILampStatics_FromIdAsync($pThis, $sDeviceId)
...
Func ILampStatics_GetDefaultAsync($pThis)
	Local $vFailVal = Ptr(0)
