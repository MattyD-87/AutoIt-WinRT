...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Automation.Peers.IItemAutomationPeerFactory
...
Global Const $sIID_IItemAutomationPeerFactory = "{FFE08885-14AC-5859-B031-5F3A4C504E6D}"
$__g_mIIDs[$sIID_IItemAutomationPeerFactory] = "IItemAutomationPeerFactory"

Global Const $tagIItemAutomationPeerFactory = $tagIInspectable & _
...
Func IItemAutomationPeerFactory_CreateInstanceWithParentAndItem($pThis, $pItem, $pParent, $pBaseInterface, ByRef $pInnerInterface)
