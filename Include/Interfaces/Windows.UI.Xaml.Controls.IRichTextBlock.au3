...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Controls.IRichTextBlock
...
Global Const $sIID_IRichTextBlock = "{E5FFF9E2-B968-49E7-97D4-8CCA2AC3AE7C}"
...
Func IRichTextBlock_Focus($pThis, $iValue)
	Local $vFailVal = Null
...
Func IRichTextBlock_GetTextIndent($pThis)
	Local $vValue = __WinRT_GetProperty_Number($pThis, 53, "double")
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IRichTextBlock_SetTextIndent($pThis, $fValue)
	Local $vValue = __WinRT_SetProperty_Number($pThis, 54, "double", $fValue)
	Return SetError(@error, @extended, $vValue)
EndFunc
