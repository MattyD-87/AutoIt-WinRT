...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Controls.IListViewHeaderItemFactory
# Incl. In  : Windows.UI.Xaml.Controls.ListViewHeaderItem

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IListViewHeaderItemFactory = "{68D2C96A-96B0-4F08-A7A5-F1086720A0FA}"
