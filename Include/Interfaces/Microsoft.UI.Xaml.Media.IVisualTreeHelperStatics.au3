...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Media.IVisualTreeHelperStatics
# Incl. In  : Microsoft.UI.Xaml.Media.VisualTreeHelper

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IVisualTreeHelperStatics = "{5AECE43C-7651-5BB5-855C-2198496E455E}"
...
Global Const $tagIVisualTreeHelperStatics = $tagIInspectable & _
		...
		"DisconnectChildrenRecursive hresult(ptr);" & _ ; In $pElement
		"GetOpenPopups hresult(ptr; ptr*);" & _ ; In $pWindow, Out $pResult
...
Func IVisualTreeHelperStatics_GetOpenPopups($pThis, $pWindow)
	Local $vFailVal = Ptr(0)
...
Func IVisualTreeHelperStatics_GetOpenPopupsForXamlRoot($pThis, $pXamlRoot)
	Local $vFailVal = Ptr(0)
