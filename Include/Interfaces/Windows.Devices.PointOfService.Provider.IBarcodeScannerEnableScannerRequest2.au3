...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.Provider.IBarcodeScannerEnableScannerRequest2
...
Global Const $sIID_IBarcodeScannerEnableScannerRequest2 = "{71A4F2A8-9905-41AC-9121-B645916A84A1}"
$__g_mIIDs[$sIID_IBarcodeScannerEnableScannerRequest2] = "IBarcodeScannerEnableScannerRequest2"

Global Const $tagIBarcodeScannerEnableScannerRequest2 = $tagIInspectable & _
...
Func IBarcodeScannerEnableScannerRequest2_ReportFailedAsync($pThis, $iReason)
...
Func IBarcodeScannerEnableScannerRequest2_ReportFailedAsync2($pThis, $iReason, $sFailedReasonDescription)
	Local $vFailVal = Ptr(0)
