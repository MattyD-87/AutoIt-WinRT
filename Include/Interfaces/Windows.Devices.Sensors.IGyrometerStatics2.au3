...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Sensors.IGyrometerStatics2
...
Global Const $sIID_IGyrometerStatics2 = "{EF83F7A1-D700-4204-9613-79C6B161DF4E}"
$__g_mIIDs[$sIID_IGyrometerStatics2] = "IGyrometerStatics2"

Global Const $tagIGyrometerStatics2 = $tagIInspectable & _
		"GetDeviceSelector hresult(handle*);" & _ ; Out $hResult
		"FromIdAsync hresult(handle; ptr*);" ; In $hDeviceId, Out $pOperation

Func IGyrometerStatics2_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func IGyrometerStatics2_FromIdAsync($pThis, $sDeviceId)
