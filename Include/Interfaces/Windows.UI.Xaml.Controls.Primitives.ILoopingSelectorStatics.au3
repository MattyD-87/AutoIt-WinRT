...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Controls.Primitives.ILoopingSelectorStatics
# Incl. In  : Windows.UI.Xaml.Controls.Primitives.LoopingSelector

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ILoopingSelectorStatics = "{03E8BAFA-8C7D-4FC5-B92A-F049FB933CC5}"
