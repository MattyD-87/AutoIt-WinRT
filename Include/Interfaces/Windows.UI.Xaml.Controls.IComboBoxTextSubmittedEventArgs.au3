...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Controls.IComboBoxTextSubmittedEventArgs
# Incl. In  : Windows.UI.Xaml.Controls.ComboBoxTextSubmittedEventArgs

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IComboBoxTextSubmittedEventArgs = "{CB698CBB-6879-558E-AF82-DF1D08F62AFA}"
