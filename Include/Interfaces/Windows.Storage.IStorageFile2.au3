...
Global Const $tagIStorageFile2 = $tagIInspectable & _
		"OpenAsync hresult(long; ulong; ptr*);" & _ ; In $iAccessMode, In $iOptions, Out $pOperation
...
Func IStorageFile2_OpenAsync($pThis, $iAccessMode, $iOptions)
	...
	Local $aCall = DllCallAddress("long", $pFunc, "ptr", $pThis, "long", $iAccessMode, "ulong", $iOptions, "ptr*", 0)
