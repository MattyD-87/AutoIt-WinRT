...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Pwm.IPwmControllerStatics3
...
Global Const $sIID_IPwmControllerStatics3 = "{B2581871-0229-4344-AE3F-9B7CD0E66B94}"
$__g_mIIDs[$sIID_IPwmControllerStatics3] = "IPwmControllerStatics3"

Global Const $tagIPwmControllerStatics3 = $tagIInspectable & _
		"GetDeviceSelector hresult(handle*);" & _ ; Out $hResult
		"GetDeviceSelector2 hresult(handle; handle*);" & _ ; In $hFriendlyName, Out $hResult
		"FromIdAsync hresult(handle; ptr*);" ; In $hDeviceId, Out $pOperation

Func IPwmControllerStatics3_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func IPwmControllerStatics3_GetDeviceSelector2($pThis, $sFriendlyName)
	Local $vFailVal = ""
...
Func IPwmControllerStatics3_FromIdAsync($pThis, $sDeviceId)
