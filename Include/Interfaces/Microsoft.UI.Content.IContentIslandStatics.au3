...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Content.IContentIslandStatics
...
Global Const $sIID_IContentIslandStatics = "{7B9EB7CC-8C43-5E0A-AB23-AB48628FD223}"
$__g_mIIDs[$sIID_IContentIslandStatics] = "IContentIslandStatics"

Global Const $tagIContentIslandStatics = $tagIInspectable & _
		"Create hresult(ptr; ptr*);" & _ ; In $pRoot, Out $pResult
		"FindAllForCompositor hresult(ptr; int*, ptr*);" & _ ; In $pCompositor, Out $iResultCnt, $pResult
		"FindAllForCurrentThread hresult(int*, ptr*);" & _ ; Out $iResultCnt, $pResult
		"GetByVisual hresult(ptr; ptr*);" & _ ; In $pChild, Out $pResult
		"GetFromId hresult(uint64; ptr*);" ; In $iId, Out $pResult

Func IContentIslandStatics_Create($pThis, $pRoot)
	...
	Local $aCall = DllCallAddress("long", $pFunc, "ptr", $pThis, "ptr", $pRoot, "ptr*", 0)
	If @error Then Return SetError(__WinRT_GetDllError(), 0, $vFailVal)
	Return SetError($aCall[0], 0, $aCall[3])
EndFunc

Func IContentIslandStatics_FindAllForCompositor($pThis, $pCompositor)
	Local $vFailVal = Ptr(0)
...
Func IContentIslandStatics_FindAllForCurrentThread($pThis)
	Local $vFailVal = Ptr(0)
...
Func IContentIslandStatics_GetByVisual($pThis, $pChild)
	Local $vFailVal = Ptr(0)
...
Func IContentIslandStatics_GetFromId($pThis, $iId)
	Local $vFailVal = Ptr(0)
