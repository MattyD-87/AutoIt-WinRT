...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.IPosPrinterStatics
...
Global Const $sIID_IPosPrinterStatics = "{8CE0D4EA-132F-4CDF-A64A-2D0D7C96A85B}"
$__g_mIIDs[$sIID_IPosPrinterStatics] = "IPosPrinterStatics"

Global Const $tagIPosPrinterStatics = $tagIInspectable & _
...
Func IPosPrinterStatics_GetDefaultAsync($pThis)
...
Func IPosPrinterStatics_FromIdAsync($pThis, $sDeviceId)
	Local $vFailVal = Ptr(0)
...
Func IPosPrinterStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
