...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Automation.Peers.ISelectorItemAutomationPeerFactory
# Incl. In  : Windows.UI.Xaml.Automation.Peers.SelectorItemAutomationPeer

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ISelectorItemAutomationPeerFactory = "{66D7EDFB-786D-4362-A964-EBFB21776C30}"
