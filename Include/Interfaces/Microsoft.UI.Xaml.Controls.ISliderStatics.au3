...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.ISliderStatics
...
Global Const $sIID_ISliderStatics = "{F0541F7B-6D81-59E2-997A-2E65FBCCCD21}"
...
Global Const $tagISliderStatics = $tagIInspectable & _
		...
		"get_ThumbToolTipValueConverterProperty hresult(ptr*);" & _ ; Out $pValue
...
Func ISliderStatics_GetHeaderProperty($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 16)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ISliderStatics_GetHeaderTemplateProperty($pThis)
