...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.ApplicationModel.Calls.IAcceptedVoipPhoneCallOptionsFactory
...
Global Const $sIID_IAcceptedVoipPhoneCallOptionsFactory = "{6CF8A79B-ACC1-54CE-A75D-CC78D17690C8}"
$__g_mIIDs[$sIID_IAcceptedVoipPhoneCallOptionsFactory] = "IAcceptedVoipPhoneCallOptionsFactory"

Global Const $tagIAcceptedVoipPhoneCallOptionsFactory = $tagIInspectable & _
		"CreateInstance hresult(ptr; ptr*);" ; In $pAssociatedDeviceIds, Out $pValue

Func IAcceptedVoipPhoneCallOptionsFactory_CreateInstance($pThis, $pAssociatedDeviceIds)
