...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorInt16BitStatics
...
Global Const $sIID_ITensorInt16BitStatics = "{98646293-266E-4B1A-821F-E60D70898B91}"
$__g_mIIDs[$sIID_ITensorInt16BitStatics] = "ITensorInt16BitStatics"

Global Const $tagITensorInt16BitStatics = $tagIInspectable & _
...
Func ITensorInt16BitStatics_Create($pThis)
...
Func ITensorInt16BitStatics_Create2($pThis, $pShape)
	Local $vFailVal = Ptr(0)
...
Func ITensorInt16BitStatics_CreateFromArray($pThis, $pShape, $aData)
	Local $vFailVal = Ptr(0)
	...
	Local $tData = DllStructCreate(StringFormat("short[%d]", $iDataCnt))
...
Func ITensorInt16BitStatics_CreateFromIterable($pThis, $pShape, $pData)
	Local $vFailVal = Ptr(0)
