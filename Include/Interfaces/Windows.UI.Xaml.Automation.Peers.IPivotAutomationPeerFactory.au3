...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Automation.Peers.IPivotAutomationPeerFactory
# Incl. In  : Windows.UI.Xaml.Automation.Peers.PivotAutomationPeer

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IPivotAutomationPeerFactory = "{3EFE0F94-0C91-4341-B9AC-1B56B4E6B84F}"
