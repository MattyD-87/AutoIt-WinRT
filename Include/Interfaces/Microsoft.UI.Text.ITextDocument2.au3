...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Text.ITextDocument2
...
Global Const $sIID_ITextDocument2 = "{21FEBCF1-2110-5879-B1DA-B343097E71E1}"
$__g_mIIDs[$sIID_ITextDocument2] = "ITextDocument2"

Global Const $tagITextDocument2 = $tagIInspectable & _
		"GetMathMode hresult(long*);" & _ ; Out $iResult
		"SetMathMode hresult(long);" & _ ; In $iMode
		"GetMathML hresult(handle*);" & _ ; Out $hValue
		"SetMathML hresult(handle);" ; In $hValue

Func ITextDocument2_GetMathMode($pThis)
	Local $vFailVal = 0
...
Func ITextDocument2_SetMathMode($pThis, $iMode)
...
Func ITextDocument2_GetMathML($pThis, ByRef $sValue)
	Local $vFailVal = False
...
Func ITextDocument2_SetMathML($pThis, $sValue)
	Local $vFailVal = False
