...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.ICashDrawerStatics
...
Global Const $sIID_ICashDrawerStatics = "{DFA0955A-D437-4FFF-B547-DDA969A4F883}"
$__g_mIIDs[$sIID_ICashDrawerStatics] = "ICashDrawerStatics"

Global Const $tagICashDrawerStatics = $tagIInspectable & _
...
Func ICashDrawerStatics_GetDefaultAsync($pThis)
...
Func ICashDrawerStatics_FromIdAsync($pThis, $sDeviceId)
	Local $vFailVal = Ptr(0)
...
Func ICashDrawerStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
