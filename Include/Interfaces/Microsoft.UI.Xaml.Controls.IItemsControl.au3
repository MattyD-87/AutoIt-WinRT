...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.IItemsControl
...
Global Const $sIID_IItemsControl = "{BF1CCB54-83E2-5B98-ACBC-736F876C3D35}"
...
Global Const $tagIItemsControl = $tagIInspectable & _
		...
		"get_ItemsPanelRoot hresult(ptr*);" & _ ; Out $pValue
		...
		"get_IsGrouping hresult(bool*);" & _ ; Out $bValue
...
Func IItemsControl_GetItemsPanelRoot($pThis)
...
Func IItemsControl_GroupHeaderContainerFromItemContainer($pThis, $pItemContainer)
