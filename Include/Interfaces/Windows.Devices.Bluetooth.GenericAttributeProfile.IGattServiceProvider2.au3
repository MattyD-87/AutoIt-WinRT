...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Bluetooth.GenericAttributeProfile.IGattServiceProvider2
...
Global Const $sIID_IGattServiceProvider2 = "{9EF531A9-CF12-59A3-A81C-362F4AABAACF}"
$__g_mIIDs[$sIID_IGattServiceProvider2] = "IGattServiceProvider2"

Global Const $tagIGattServiceProvider2 = $tagIInspectable & _
		"UpdateAdvertisingParameters hresult(ptr);" ; In $pParameters

Func IGattServiceProvider2_UpdateAdvertisingParameters($pThis, $pParameters)
