...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Networking.Sockets.IDatagramSocket3
...
Global Const $sIID_IDatagramSocket3 = "{37544F09-AB92-4306-9AC1-0C381283D9C6}"
$__g_mIIDs[$sIID_IDatagramSocket3] = "IDatagramSocket3"

Global Const $tagIDatagramSocket3 = $tagIInspectable & _
...
Func IDatagramSocket3_CancelIOAsync($pThis)
...
Func IDatagramSocket3_EnableTransferOwnership($pThis, $pTaskId)
...
Func IDatagramSocket3_EnableTransferOwnership2($pThis, $pTaskId, $iConnectedStandbyAction)
	Local $vFailVal = False
...
Func IDatagramSocket3_TransferOwnership($pThis, $sSocketId)
	Local $vFailVal = False
...
Func IDatagramSocket3_TransferOwnership2($pThis, $sSocketId, $pData)
	Local $vFailVal = False
...
Func IDatagramSocket3_TransferOwnership3($pThis, $sSocketId, $pData, $iKeepAliveTime)
	Local $vFailVal = False
