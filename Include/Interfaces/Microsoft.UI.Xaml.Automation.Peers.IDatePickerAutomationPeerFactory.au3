...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Automation.Peers.IDatePickerAutomationPeerFactory
# Incl. In  : Microsoft.UI.Xaml.Automation.Peers.DatePickerAutomationPeer

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IDatePickerAutomationPeerFactory = "{480F7825-B4A7-5C56-9F8A-FED84B9348AE}"
