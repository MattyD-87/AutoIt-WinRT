...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.ITimePicker
...
Global Const $sIID_ITimePicker = "{ED4BAA33-C240-5934-9229-82D37B26F846}"
...
Global Const $tagITimePicker = $tagIInspectable & _
		...
		"remove_TimeChanged hresult(int64);" & _ ; In $iToken
...
Func ITimePicker_GetLightDismissOverlayMode($pThis)
	Local $vValue = __WinRT_GetProperty_Number($pThis, 17, "long")
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITimePicker_SetLightDismissOverlayMode($pThis, $iValue)
	Local $vValue = __WinRT_SetProperty_Number($pThis, 18, "long", $iValue)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITimePicker_GetSelectedTime($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 19)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITimePicker_SetSelectedTime($pThis, $pValue)
...
Func ITimePicker_AddHdlrSelectedTimeChanged($pThis, $pHandler)
	Local $vValue = __WinRT_AddHandler($pThis, 23, $pHandler)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITimePicker_RemoveHdlrSelectedTimeChanged($pThis, $iToken)
