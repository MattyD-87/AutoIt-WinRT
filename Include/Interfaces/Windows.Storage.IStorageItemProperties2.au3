...
Global Const $tagIStorageItemProperties2 = $tagIInspectable & _
		"GetScaledImageAsThumbnailAsync hresult(long; ptr*);" & _ ; In $iMode, Out $pOperation
		"GetScaledImageAsThumbnailAsync2 hresult(long; ulong; ptr*);" & _ ; In $iMode, In $iRequestedSize, Out $pOperation
		"GetScaledImageAsThumbnailAsync3 hresult(long; ulong; ulong; ptr*);" ; In $iMode, In $iRequestedSize, In $iOptions, Out $pOperation
