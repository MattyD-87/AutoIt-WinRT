...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.INavigationViewTemplateSettingsStatics
...
Global Const $sIID_INavigationViewTemplateSettingsStatics = "{BE3A88D6-D19B-5543-8B72-D42B459E72ED}"
...
Global Const $tagINavigationViewTemplateSettingsStatics = $tagIInspectable & _
		...
		"get_PaneToggleButtonWidthProperty hresult(ptr*);" & _ ; Out $pValue
		"get_SmallerPaneToggleButtonWidthProperty hresult(ptr*);" ; Out $pValue
...
Func INavigationViewTemplateSettingsStatics_GetPaneToggleButtonWidthProperty($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 14)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func INavigationViewTemplateSettingsStatics_GetSmallerPaneToggleButtonWidthProperty($pThis)
