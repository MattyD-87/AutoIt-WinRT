...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Automation.IRangeValuePatternIdentifiersStatics
# Incl. In  : Windows.UI.Xaml.Automation.RangeValuePatternIdentifiers

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IRangeValuePatternIdentifiersStatics = "{CE23450F-1C27-457F-B815-7A5E46863DBB}"
