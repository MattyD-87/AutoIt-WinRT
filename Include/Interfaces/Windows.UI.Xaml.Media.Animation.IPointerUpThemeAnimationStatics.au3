...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Media.Animation.IPointerUpThemeAnimationStatics
# Incl. In  : Windows.UI.Xaml.Media.Animation.PointerUpThemeAnimation

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IPointerUpThemeAnimationStatics = "{7C618F9C-7992-4139-8BFC-0883B9727A7E}"
