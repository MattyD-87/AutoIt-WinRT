...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Scanners.IImageScannerStatics
...
Global Const $sIID_IImageScannerStatics = "{BC57E70E-D804-4477-9FB5-B911B5473897}"
$__g_mIIDs[$sIID_IImageScannerStatics] = "IImageScannerStatics"

Global Const $tagIImageScannerStatics = $tagIInspectable & _
		"FromIdAsync hresult(handle; ptr*);" & _ ; In $hDeviceId, Out $pAsyncInfo
		"GetDeviceSelector hresult(handle*);" ; Out $hSelector

Func IImageScannerStatics_FromIdAsync($pThis, $sDeviceId)
...
Func IImageScannerStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
