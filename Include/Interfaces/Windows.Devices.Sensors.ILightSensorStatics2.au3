...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Sensors.ILightSensorStatics2
...
Global Const $sIID_ILightSensorStatics2 = "{0EC0A650-DDC6-40AB-ACE3-EC3359D42C51}"
$__g_mIIDs[$sIID_ILightSensorStatics2] = "ILightSensorStatics2"

Global Const $tagILightSensorStatics2 = $tagIInspectable & _
		"GetDeviceSelector hresult(handle*);" & _ ; Out $hResult
		"FromIdAsync hresult(handle; ptr*);" ; In $hDeviceId, Out $pOperation

Func ILightSensorStatics2_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func ILightSensorStatics2_FromIdAsync($pThis, $sDeviceId)
