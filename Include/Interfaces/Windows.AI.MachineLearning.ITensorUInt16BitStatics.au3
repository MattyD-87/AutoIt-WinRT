...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorUInt16BitStatics
...
Global Const $sIID_ITensorUInt16BitStatics = "{5DF745DD-028A-481A-A27C-C7E6435E52DD}"
$__g_mIIDs[$sIID_ITensorUInt16BitStatics] = "ITensorUInt16BitStatics"

Global Const $tagITensorUInt16BitStatics = $tagIInspectable & _
...
Func ITensorUInt16BitStatics_Create($pThis)
...
Func ITensorUInt16BitStatics_Create2($pThis, $pShape)
	Local $vFailVal = Ptr(0)
...
Func ITensorUInt16BitStatics_CreateFromArray($pThis, $pShape, $aData)
	Local $vFailVal = Ptr(0)
	...
	Local $tData = DllStructCreate(StringFormat("ushort[%d]", $iDataCnt))
...
Func ITensorUInt16BitStatics_CreateFromIterable($pThis, $pShape, $pData)
	Local $vFailVal = Ptr(0)
