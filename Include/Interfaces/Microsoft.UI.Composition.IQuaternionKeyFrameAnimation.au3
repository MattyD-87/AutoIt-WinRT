...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Composition.IQuaternionKeyFrameAnimation
# Incl. In  : Microsoft.UI.Composition.QuaternionKeyFrameAnimation

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IQuaternionKeyFrameAnimation = "{E72D1026-DA3B-5D56-858B-3A9AA3C57D70}"
$__g_mIIDs[$sIID_IQuaternionKeyFrameAnimation] = "IQuaternionKeyFrameAnimation"

Global Const $tagIQuaternionKeyFrameAnimation = $tagIInspectable & _
...
Func IQuaternionKeyFrameAnimation_InsertKeyFrame($pThis, $fNormalizedProgressKey, $tValue)
...
Func IQuaternionKeyFrameAnimation_InsertKeyFrame2($pThis, $fNormalizedProgressKey, $tValue, $pEasingFunction)
	Local $vFailVal = False
