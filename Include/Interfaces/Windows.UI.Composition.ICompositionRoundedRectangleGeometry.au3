...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Composition.ICompositionRoundedRectangleGeometry
# Incl. In  : Windows.UI.Composition.CompositionRoundedRectangleGeometry

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ICompositionRoundedRectangleGeometry = "{8770C822-1D50-4B8B-B013-7C9A0E46935F}"
