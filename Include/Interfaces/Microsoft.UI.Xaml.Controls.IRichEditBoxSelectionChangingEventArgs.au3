...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.IRichEditBoxSelectionChangingEventArgs
# Incl. In  : Microsoft.UI.Xaml.Controls.RichEditBoxSelectionChangingEventArgs

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IRichEditBoxSelectionChangingEventArgs = "{5DBADBE1-0515-5045-9A6F-6859237301AC}"
