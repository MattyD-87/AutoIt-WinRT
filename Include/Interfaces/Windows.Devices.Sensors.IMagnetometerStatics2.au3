...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Sensors.IMagnetometerStatics2
...
Global Const $sIID_IMagnetometerStatics2 = "{2C0819F0-FFC6-4F89-A06F-18FA10792933}"
$__g_mIIDs[$sIID_IMagnetometerStatics2] = "IMagnetometerStatics2"

Global Const $tagIMagnetometerStatics2 = $tagIInspectable & _
		"GetDeviceSelector hresult(handle*);" & _ ; Out $hResult
		"FromIdAsync hresult(handle; ptr*);" ; In $hDeviceId, Out $pOperation

Func IMagnetometerStatics2_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func IMagnetometerStatics2_FromIdAsync($pThis, $sDeviceId)
