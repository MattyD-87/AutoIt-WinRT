...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Lights.ILampArrayStatics
...
Global Const $sIID_ILampArrayStatics = "{7BB8C98D-5FC1-452D-BB1F-4AD410D398FF}"
$__g_mIIDs[$sIID_ILampArrayStatics] = "ILampArrayStatics"

Global Const $tagILampArrayStatics = $tagIInspectable & _
		"GetDeviceSelector hresult(handle*);" & _ ; Out $hResult
		"FromIdAsync hresult(handle; ptr*);" ; In $hDeviceId, Out $pOperation

Func ILampArrayStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
...
Func ILampArrayStatics_FromIdAsync($pThis, $sDeviceId)
