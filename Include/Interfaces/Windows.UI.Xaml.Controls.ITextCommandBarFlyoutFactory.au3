...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Controls.ITextCommandBarFlyoutFactory
# Incl. In  : Windows.UI.Xaml.Controls.TextCommandBarFlyout

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ITextCommandBarFlyoutFactory = "{1B5918D8-B006-5ECD-AB72-6FDB48ABC1F4}"
