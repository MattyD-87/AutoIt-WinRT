...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.ISlider
# Incl. In  : Microsoft.UI.Xaml.Controls.Slider

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ISlider = "{F7418ECF-7C35-5216-8BF1-D82D47CCE5DF}"
...
Global Const $tagISlider = $tagIInspectable & _
		...
		"put_ThumbToolTipValueConverter hresult(ptr);" & _ ; In $pValue
...
Func ISlider_GetHeader($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 25)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ISlider_SetHeader($pThis, $pValue)
	Local $vValue = __WinRT_SetProperty_Ptr($pThis, 26, $pValue)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ISlider_GetHeaderTemplate($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 27)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ISlider_SetHeaderTemplate($pThis, $pValue)
