...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.Windows.SemanticSearch.IEmbeddingVector
...
Global Const $sIID_IEmbeddingVector = "{F80248AA-68E7-5DE0-9166-B26E58935D34}"
...
Global Const $tagIEmbeddingVector = $tagIInspectable & _
		...
		"get_Count hresult(ulong*);" & _ ; Out $iValue
...
Func IEmbeddingVector_GetCount($pThis)
