...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Automation.Peers.IPivotItemAutomationPeerFactory
# Incl. In  : Microsoft.UI.Xaml.Automation.Peers.PivotItemAutomationPeer

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IPivotItemAutomationPeerFactory = "{14966EE7-AFAF-5FCC-9346-F0E7192C220A}"
