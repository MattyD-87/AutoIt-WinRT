...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Automation.Peers.IComboBoxItemAutomationPeerFactory
# Incl. In  : Windows.UI.Xaml.Automation.Peers.ComboBoxItemAutomationPeer

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IComboBoxItemAutomationPeerFactory = "{134AC7FC-397A-403F-A6EC-1CE8BEDA15E5}"
