...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Controls.Primitives.ISplitViewTemplateSettings
# Incl. In  : Windows.UI.Xaml.Controls.Primitives.SplitViewTemplateSettings

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ISplitViewTemplateSettings = "{C16AB5A7-4996-4443-B199-6B6B89124EAB}"
