...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Networking.Sockets.IStreamSocketListener3
...
Global Const $sIID_IStreamSocketListener3 = "{4798201C-BDF8-4919-8542-28D450E74507}"
$__g_mIIDs[$sIID_IStreamSocketListener3] = "IStreamSocketListener3"

Global Const $tagIStreamSocketListener3 = $tagIInspectable & _
		...
		"TransferOwnership2 hresult(handle; ptr);" ; In $hSocketId, In $pData

Func IStreamSocketListener3_CancelIOAsync($pThis)
...
Func IStreamSocketListener3_EnableTransferOwnership($pThis, $pTaskId)
...
Func IStreamSocketListener3_EnableTransferOwnership2($pThis, $pTaskId, $iConnectedStandbyAction)
	Local $vFailVal = False
...
Func IStreamSocketListener3_TransferOwnership($pThis, $sSocketId)
	Local $vFailVal = False
...
Func IStreamSocketListener3_TransferOwnership2($pThis, $sSocketId, $pData)
	Local $vFailVal = False
