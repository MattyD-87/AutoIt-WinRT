...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Sensors.IBarometerStatics2
...
Global Const $sIID_IBarometerStatics2 = "{8FC6B1E7-95FF-44AC-878E-D65C8308C34C}"
$__g_mIIDs[$sIID_IBarometerStatics2] = "IBarometerStatics2"

Global Const $tagIBarometerStatics2 = $tagIInspectable & _
		"FromIdAsync hresult(handle; ptr*);" & _ ; In $hDeviceId, Out $pOperation
		"GetDeviceSelector hresult(handle*);" ; Out $hResult

Func IBarometerStatics2_FromIdAsync($pThis, $sDeviceId)
...
Func IBarometerStatics2_GetDeviceSelector($pThis)
	Local $vFailVal = ""
