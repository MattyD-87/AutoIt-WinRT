...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Lights.Effects.ILampArrayBlinkEffectFactory
...
Global Const $sIID_ILampArrayBlinkEffectFactory = "{879F1D97-9F50-49B2-A56F-013AA08D55E0}"
$__g_mIIDs[$sIID_ILampArrayBlinkEffectFactory] = "ILampArrayBlinkEffectFactory"

Global Const $tagILampArrayBlinkEffectFactory = $tagIInspectable & _
		"CreateInstance hresult(ptr; int; struct*; ptr*);" ; In $pLampArray, In $iLampIndexesCnt, $tLampIndexes, Out $pValue

Func ILampArrayBlinkEffectFactory_CreateInstance($pThis, $pLampArray, $aLampIndexes)
