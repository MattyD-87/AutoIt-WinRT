...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Automation.Peers.IButtonAutomationPeerFactory
...
Global Const $sIID_IButtonAutomationPeerFactory = "{1C2F87B7-FBC1-56B0-A654-550D61C423D1}"
$__g_mIIDs[$sIID_IButtonAutomationPeerFactory] = "IButtonAutomationPeerFactory"

Global Const $tagIButtonAutomationPeerFactory = $tagIInspectable & _
		"CreateInstanceWithOwner hresult(ptr; ptr; ptr*; ptr*);" ; In $pOwner, In $pBaseInterface, Out $pInnerInterface, Out $pValue

Func IButtonAutomationPeerFactory_CreateInstanceWithOwner($pThis, $pOwner, $pBaseInterface, ByRef $pInnerInterface)
