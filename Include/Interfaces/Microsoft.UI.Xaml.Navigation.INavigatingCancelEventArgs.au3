...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Navigation.INavigatingCancelEventArgs
# Incl. In  : Microsoft.UI.Xaml.Navigation.NavigatingCancelEventArgs

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_INavigatingCancelEventArgs = "{172FDE12-E06F-5DF6-930E-5FACF7B3FBE7}"
...
Func INavigatingCancelEventArgs_GetParameter($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 11)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func INavigatingCancelEventArgs_GetNavigationTransitionInfo($pThis)
