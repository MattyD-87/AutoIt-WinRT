...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.ISwapChainPanel
...
Global Const $sIID_ISwapChainPanel = "{08844F85-AA1B-540D-BEF2-B2BB7B257F8C}"
...
Global Const $tagISwapChainPanel = $tagIInspectable & _
		...
		"CreateCoreIndependentInputSource hresult(ulong; ptr*);" ; In $iDeviceKinds, Out $pResult
...
Func ISwapChainPanel_CreateCoreIndependentInputSource($pThis, $iDeviceKinds)
	Local $vFailVal = Ptr(0)
	Local $pFunc = __WinRT_GetFuncAddress($pThis, 11)
	If @error Then Return SetError(@error, @extended, $vFailVal)
	If ($iDeviceKinds) And (Not IsInt($iDeviceKinds)) Then Return SetError($ERROR_INVALID_PARAMETER, 0, $vFailVal)
	Local $aCall = DllCallAddress("long", $pFunc, "ptr", $pThis, "ulong", $iDeviceKinds, "ptr*", 0)
