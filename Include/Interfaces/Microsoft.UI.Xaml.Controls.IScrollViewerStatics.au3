...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Microsoft.UI.Xaml.Controls.IScrollViewerStatics
...
Global Const $sIID_IScrollViewerStatics = "{D971FD86-0A96-50C4-A6E1-9975FAA2A142}"
...
Global Const $tagIScrollViewerStatics = $tagIInspectable & _
		...
		"get_TopHeaderProperty hresult(ptr*);" & _ ; Out $pValue
		...
		"SetCanContentRenderOutsideBounds hresult(ptr; bool);" & _ ; In $pElement, In $bCanContentRenderOutsideBounds
...
Func IScrollViewerStatics_GetTopLeftHeaderProperty($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 26)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IScrollViewerStatics_GetLeftHeaderProperty($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 27)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IScrollViewerStatics_GetTopHeaderProperty($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 28)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IScrollViewerStatics_GetReduceViewportForCoreInputViewOcclusionsProperty($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 29)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IScrollViewerStatics_GetHorizontalAnchorRatioProperty($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 30)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IScrollViewerStatics_GetVerticalAnchorRatioProperty($pThis)
...
Func IScrollViewerStatics_GetCanContentRenderOutsideBoundsProperty($pThis)
	Local $vValue = __WinRT_GetProperty_Ptr($pThis, 68)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IScrollViewerStatics_GetCanContentRenderOutsideBounds($pThis, $pElement)
	Local $vFailVal = Null
...
Func IScrollViewerStatics_SetCanContentRenderOutsideBounds($pThis, $pElement, $bCanContentRenderOutsideBounds)
	Local $vFailVal = False
