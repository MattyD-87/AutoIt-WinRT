...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.IMagneticStripeReaderStatics
...
Global Const $sIID_IMagneticStripeReaderStatics = "{C45FAB4A-EFD7-4760-A5CE-15B0E47E94EB}"
$__g_mIIDs[$sIID_IMagneticStripeReaderStatics] = "IMagneticStripeReaderStatics"

Global Const $tagIMagneticStripeReaderStatics = $tagIInspectable & _
...
Func IMagneticStripeReaderStatics_GetDefaultAsync($pThis)
...
Func IMagneticStripeReaderStatics_FromIdAsync($pThis, $sDeviceId)
	Local $vFailVal = Ptr(0)
...
Func IMagneticStripeReaderStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
