...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Foundation.Collections.IVector
# Incl. In  : Microsoft.UI.Composition.CompositionColorGradientStopCollection
...
$__g_mIIDs[$sIID_IVector] = "IVector"

Global Const $tagIVector = $tagIInspectable & _
		"GetAt hresult(ulong; ptr*);" & _ ; In $iIndex, Out $pValue
		"get_Size hresult(ulong*);" & _ ; Out $iValue
		"GetView hresult(ptr*);" & _ ; Out $pValue
		...
		"Clear hresult();" & _ ; 
		"GetMany hresult(ulong; int; struct*; ulong*);" & _ ; In $iStartIndex, Out $iItemsCnt, $tItems, Out $iValue
		"ReplaceAll hresult(int; struct*);" ; In $iItemsCnt, $tItems
