...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorUInt16BitStatics2
...
Global Const $sIID_ITensorUInt16BitStatics2 = "{8AF40C64-D69F-5315-9348-490877BBD642}"
$__g_mIIDs[$sIID_ITensorUInt16BitStatics2] = "ITensorUInt16BitStatics2"

Global Const $tagITensorUInt16BitStatics2 = $tagIInspectable & _
...
Func ITensorUInt16BitStatics2_CreateFromShapeArrayAndDataArray($pThis, $aShape, $aData)
...
Func ITensorUInt16BitStatics2_CreateFromBuffer($pThis, $aShape, $pBuffer)
	Local $vFailVal = Ptr(0)
