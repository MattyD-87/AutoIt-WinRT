...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Markup.IXamlBinaryWriterStatics
# Incl. In  : Windows.UI.Xaml.Markup.XamlBinaryWriter

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IXamlBinaryWriterStatics = "{0D8ED07A-9B82-4AA8-B68B-026F2DE1CC86}"
