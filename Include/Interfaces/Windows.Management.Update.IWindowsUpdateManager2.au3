...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Management.Update.IWindowsUpdateManager2
...
Global Const $sIID_IWindowsUpdateManager2 = "{564E7683-BD21-57A4-B17F-7BF6350F4C75}"
$__g_mIIDs[$sIID_IWindowsUpdateManager2] = "IWindowsUpdateManager2"

Global Const $tagIWindowsUpdateManager2 = $tagIInspectable & _
		"GetProvider hresult(handle; ptr*);" & _ ; In $hId, Out $pResult
		"get_ProviderIds hresult(int*, ptr*);" & _ ; Out $iValueCnt, $pValue
		"GetApplicableSoftwareUpdates hresult(ptr*);" & _ ; Out $pResult
		"PerformScan hresult(ptr; ptr*);" ; In $pOptions, Out $pResult

Func IWindowsUpdateManager2_GetProvider($pThis, $sId)
...
Func IWindowsUpdateManager2_GetProviderIds($pThis)
	Local $vFailVal[0]
...
Func IWindowsUpdateManager2_GetApplicableSoftwareUpdates($pThis)
	Local $vFailVal = Ptr(0)
...
Func IWindowsUpdateManager2_PerformScan($pThis, $pOptions)
	Local $vFailVal = Ptr(0)
