...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Media.Imaging.ISoftwareBitmapSource
# Incl. In  : Windows.UI.Xaml.Media.Imaging.SoftwareBitmapSource

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ISoftwareBitmapSource = "{D2DD9ED0-D3C5-4056-91B5-B7C1D1E8130E}"
