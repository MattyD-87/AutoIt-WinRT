...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorInt64BitStatics
...
Global Const $sIID_ITensorInt64BitStatics = "{9648AD9D-1198-4D74-9517-783AB62B9CC2}"
$__g_mIIDs[$sIID_ITensorInt64BitStatics] = "ITensorInt64BitStatics"

Global Const $tagITensorInt64BitStatics = $tagIInspectable & _
...
Func ITensorInt64BitStatics_Create($pThis)
...
Func ITensorInt64BitStatics_Create2($pThis, $pShape)
	Local $vFailVal = Ptr(0)
...
Func ITensorInt64BitStatics_CreateFromArray($pThis, $pShape, $aData)
	Local $vFailVal = Ptr(0)
	...
	Local $tData = DllStructCreate(StringFormat("int64[%d]", $iDataCnt))
...
Func ITensorInt64BitStatics_CreateFromIterable($pThis, $pShape, $pData)
	Local $vFailVal = Ptr(0)
