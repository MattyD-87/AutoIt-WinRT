...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Controls.Primitives.IPickerFlyoutBaseOverrides
# Incl. In  : Windows.UI.Xaml.Controls.Primitives.PickerFlyoutBase

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IPickerFlyoutBaseOverrides = "{5BFC4F4A-4822-47B4-A958-77C20BA120D3}"
