...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorInt64BitStatics2
...
Global Const $sIID_ITensorInt64BitStatics2 = "{6D3D9DCB-FF40-5EC2-89FE-084E2B6BC6DB}"
$__g_mIIDs[$sIID_ITensorInt64BitStatics2] = "ITensorInt64BitStatics2"

Global Const $tagITensorInt64BitStatics2 = $tagIInspectable & _
...
Func ITensorInt64BitStatics2_CreateFromShapeArrayAndDataArray($pThis, $aShape, $aData)
...
Func ITensorInt64BitStatics2_CreateFromBuffer($pThis, $aShape, $pBuffer)
	Local $vFailVal = Ptr(0)
