...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.AI.MachineLearning.ITensorInt32BitStatics2
...
Global Const $sIID_ITensorInt32BitStatics2 = "{7C4B079A-E956-5CE0-A3BD-157D9D79B5EC}"
$__g_mIIDs[$sIID_ITensorInt32BitStatics2] = "ITensorInt32BitStatics2"

Global Const $tagITensorInt32BitStatics2 = $tagIInspectable & _
...
Func ITensorInt32BitStatics2_CreateFromShapeArrayAndDataArray($pThis, $aShape, $aData)
...
Func ITensorInt32BitStatics2_CreateFromBuffer($pThis, $aShape, $pBuffer)
	Local $vFailVal = Ptr(0)
