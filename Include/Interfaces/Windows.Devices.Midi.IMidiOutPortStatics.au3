...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Midi.IMidiOutPortStatics
# Incl. In  : Windows.Devices.Midi.MidiOutPort

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IMidiOutPortStatics = "{065CC3E9-0F88-448B-9B64-A95826C65B8F}"
$__g_mIIDs[$sIID_IMidiOutPortStatics] = "IMidiOutPortStatics"

Global Const $tagIMidiOutPortStatics = $tagIInspectable & _
		"FromIdAsync hresult(handle; ptr*);" & _ ; In $hDeviceId, Out $pValue
		"GetDeviceSelector hresult(handle*);" ; Out $hValue

Func IMidiOutPortStatics_FromIdAsync($pThis, $sDeviceId)
...
Func IMidiOutPortStatics_GetDeviceSelector($pThis)
	Local $vFailVal = ""
