...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Media.Media3D.ICompositeTransform3DStatics
# Incl. In  : Windows.UI.Xaml.Media.Media3D.CompositeTransform3D

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_ICompositeTransform3DStatics = "{DDBF4D67-2A25-48F3-9808-C51EC3D55BEC}"
