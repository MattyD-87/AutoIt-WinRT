...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Media.Effects.IVideoEffectDefinitionFactory
# Incl. In  : Windows.Media.Effects.VideoEffectDefinition

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IVideoEffectDefinitionFactory = "{81439B4E-6E33-428F-9D21-B5AAFEF7617C}"
$__g_mIIDs[$sIID_IVideoEffectDefinitionFactory] = "IVideoEffectDefinitionFactory"

Global Const $tagIVideoEffectDefinitionFactory = $tagIInspectable & _
...
Func IVideoEffectDefinitionFactory_Create($pThis, $sActivatableClassId)
...
Func IVideoEffectDefinitionFactory_CreateWithProperties($pThis, $sActivatableClassId, $pProps)
	Local $vFailVal = Ptr(0)
