...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Data.Text.ITextPredictionGenerator
...
Global Const $sIID_ITextPredictionGenerator = "{5EACAB07-ABF1-4CB6-9D9E-326F2B468756}"
$__g_mIIDs[$sIID_ITextPredictionGenerator] = "ITextPredictionGenerator"

Global Const $tagITextPredictionGenerator = $tagIInspectable & _
...
Func ITextPredictionGenerator_GetResolvedLanguage($pThis)
	Local $vValue = __WinRT_GetProperty_HString($pThis, 7)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITextPredictionGenerator_GetLanguageAvailableButNotInstalled($pThis)
	Local $vValue = __WinRT_GetProperty_Bool($pThis, 8)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func ITextPredictionGenerator_GetCandidatesAsync($pThis, $sInput)
...
Func ITextPredictionGenerator_GetCandidatesAsync2($pThis, $sInput, $iMaxCandidates)
	Local $vFailVal = Ptr(0)
