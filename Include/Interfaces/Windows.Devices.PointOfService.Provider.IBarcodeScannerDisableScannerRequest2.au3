...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.Provider.IBarcodeScannerDisableScannerRequest2
...
Global Const $sIID_IBarcodeScannerDisableScannerRequest2 = "{CCDFE625-65C3-4CCC-B457-F39C7A9EA60D}"
$__g_mIIDs[$sIID_IBarcodeScannerDisableScannerRequest2] = "IBarcodeScannerDisableScannerRequest2"

Global Const $tagIBarcodeScannerDisableScannerRequest2 = $tagIInspectable & _
...
Func IBarcodeScannerDisableScannerRequest2_ReportFailedAsync($pThis, $iReason)
...
Func IBarcodeScannerDisableScannerRequest2_ReportFailedAsync2($pThis, $iReason, $sFailedReasonDescription)
	Local $vFailVal = Ptr(0)
