...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Storage.Pickers.IFileOpenPicker
...
Global Const $sIID_IFileOpenPicker = "{2CA8278A-12C5-4C5F-8977-94547793C241}"
...
Func IFileOpenPicker_GetSettingsIdentifier($pThis)
	Local $vValue = __WinRT_GetProperty_HString($pThis, 9)
	Return SetError(@error, @extended, $vValue)
EndFunc

Func IFileOpenPicker_SetSettingsIdentifier($pThis, $sValue)
