...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.Provider.IBarcodeScannerSetActiveSymbologiesRequest2
...
Global Const $sIID_IBarcodeScannerSetActiveSymbologiesRequest2 = "{F5FF6EDF-FA9A-4749-B11B-E8FCCB75BC6B}"
$__g_mIIDs[$sIID_IBarcodeScannerSetActiveSymbologiesRequest2] = "IBarcodeScannerSetActiveSymbologiesRequest2"

Global Const $tagIBarcodeScannerSetActiveSymbologiesRequest2 = $tagIInspectable & _
...
Func IBarcodeScannerSetActiveSymbologiesRequest2_ReportFailedAsync($pThis, $iReason)
...
Func IBarcodeScannerSetActiveSymbologiesRequest2_ReportFailedAsync2($pThis, $iReason, $sFailedReasonDescription)
	Local $vFailVal = Ptr(0)
