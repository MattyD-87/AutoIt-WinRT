...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Input.IMouseWheelParameters
# Incl. In  : Windows.UI.Input.MouseWheelParameters

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IMouseWheelParameters = "{EAD0CA44-9DED-4037-8149-5E4CC2564468}"
