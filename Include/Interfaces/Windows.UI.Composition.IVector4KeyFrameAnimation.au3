...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Composition.IVector4KeyFrameAnimation
# Incl. In  : Windows.UI.Composition.Vector4KeyFrameAnimation

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IVector4KeyFrameAnimation = "{2457945B-ADDD-4385-9606-B6A3D5E4E1B9}"
