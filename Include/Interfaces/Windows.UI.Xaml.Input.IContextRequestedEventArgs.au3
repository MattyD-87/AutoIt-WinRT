...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.UI.Xaml.Input.IContextRequestedEventArgs
# Incl. In  : Windows.UI.Xaml.Input.ContextRequestedEventArgs

#include-once
#include "..\WinRTCore.au3"
#include "IInspectable.au3"

Global Const $sIID_IContextRequestedEventArgs = "{42618E0A-1CB6-46FB-8374-0AEC68AA5E51}"
