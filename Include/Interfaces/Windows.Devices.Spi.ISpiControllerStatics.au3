...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.Spi.ISpiControllerStatics
...
Global Const $sIID_ISpiControllerStatics = "{0D5229E2-138B-4E48-B964-4F2F79B9C5A2}"
$__g_mIIDs[$sIID_ISpiControllerStatics] = "ISpiControllerStatics"

Global Const $tagISpiControllerStatics = $tagIInspectable & _
		"GetDefaultAsync hresult(ptr*);" & _ ; Out $pOperation
		"GetControllersAsync hresult(ptr; ptr*);" ; In $pProvider, Out $pOperation

Func ISpiControllerStatics_GetDefaultAsync($pThis)
...
Func ISpiControllerStatics_GetControllersAsync($pThis, $pProvider)
	Local $vFailVal = Ptr(0)
