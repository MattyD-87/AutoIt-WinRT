...
# WinAppSDK : 2.0 
# File Type : Interface
# File Name : Windows.Devices.PointOfService.Provider.IBarcodeScannerHideVideoPreviewRequest2
...
Global Const $sIID_IBarcodeScannerHideVideoPreviewRequest2 = "{7E28435D-9814-431D-A2F2-D6248C5AD4B5}"
$__g_mIIDs[$sIID_IBarcodeScannerHideVideoPreviewRequest2] = "IBarcodeScannerHideVideoPreviewRequest2"

Global Const $tagIBarcodeScannerHideVideoPreviewRequest2 = $tagIInspectable & _
...
Func IBarcodeScannerHideVideoPreviewRequest2_ReportFailedAsync($pThis, $iReason)
...
Func IBarcodeScannerHideVideoPreviewRequest2_ReportFailedAsync2($pThis, $iReason, $sFailedReasonDescription)
	Local $vFailVal = Ptr(0)
